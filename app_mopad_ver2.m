classdef app_mopad_ver2 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function MOSTRARPOSButtonValueChanged(app, event)
            ...
            while app.MOSTRARPOSButton.Value==true && canTransform(app.tftree,'odom','map')
                ...
                y = round(-(pos_map.Pose.Position.Y-app.origin)/app.resolution+size(app.mapa,1));
        ...
        function HOMEButtonPushed(app, event)
            %Establece un HOME para retorno del robot
                ...
                app.home_x = round((pos_map.Pose.Position.X- app.origin)/app.resolution);
                app.home_y = round(-(pos_map.Pose.Position.Y-app.origin)/app.resolution+821);
